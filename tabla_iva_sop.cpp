...
void tabla_iva_sop::pasa_info(QString qejercicio, bool qfechacontable,
                              ...
                              bool qimportaciones, QString cuenta)
...
void tabla_iva_sop::refrescar()
{
 ...
 if (!paraliquidacion)
   registros = basedatos::instancia()->num_registros_recibidas(ejercicio, fechacontable,
                                        ...
                                        importaciones,solo_caja, cuenta_factura);
    ...
    while ( query.next() )
      {
       ...
       QString nombre= (query.value(15).toString().isEmpty() ?
       ...
       QString cif = (query.value(16).toString().isEmpty() ?
